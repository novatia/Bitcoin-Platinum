...
public:
    CMainParams() {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("4104f4810ede0b1f61f85f1db8ce45e20ce3b786b2c28a46cf2d8c0c6b7318ef3b50beae12dc027e96887f4ac2ab8fc1f69868484708de3c7167dd381951545c3b86ac") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1507889514;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 75215479;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000000033dfab3660127b7ab95244d6d8d85612c80c9790e6a6aa8ccbcb9796"));
        assert(genesis.hashMerkleRoot == uint256("0x9a9be89c6262b586e3bd1085f821befd7add097abdc6869f271d8ae8532a2d6e"));
		vSeeds.clear();
      ...
      //  vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
       // vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.bitcoin.dashjr.org"));
        ...
        for (unsigned int i = 0; i < ARRAYLEN(pnSeed); i++)
        {
            ...
            // weeks ago.
            const int64_t nOneWeek = 5*24*60*60;
            struct in_addr ip;
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1509089272;
        genesis.nNonce = 917432611;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000000077a03df3f488ecd7321849777d271f0d8e11a36fec586d04e93fcffa"));
...
public:
    CRegTestParams() {
        ...
        bnProofOfWorkLimit = CBigNum(~uint256(0) >> 1);
  	    genesis.nVersion = 1;
        genesis.nTime = 1509093656;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 4129853205;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 20253;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x000000006eb2de38738f794c5fb9b25275e40bd24b539e5242fe3636f56ab862"));
